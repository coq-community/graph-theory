...
E:\Coq\bin\coqc.exe -R theories GraphTheory -w -notation-overridden theories\structures.v
...
E:\Coq\bin\coqc.exe -R theories GraphTheory -w -notation-overridden theories\finite_quotient.v
E:\Coq\bin\coqc.exe -R theories GraphTheory -w -notation-overridden theories\equiv.v
...
E:\Coq\bin\coqc.exe -R theories GraphTheory -w -notation-overridden theories\mgraph.v
