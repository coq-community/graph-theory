...
(* TODO: structure inference for [test A] to [pttdom_monoid (tm_pttdom A)] *)
...
Lemma tgraph_graph (u: term): 
  tgraph_of_term u ≃2 
  @relabel2 _ (pttdom_monoid (tm_pttdom A)) _ (pttdom_elabel (tm_pttdom A))
    (fun _ => tst_one _) (fun x : flat A => @pttdom.tm_var _ x) (graph_of_term u).
Proof.
